...
public class OrganizationNotificationTemplatesTestCase extends ISIntegrationTest {
    ...
    public void init() throws Exception {
        ...
        List<String> authorizedScopes1 = new ArrayList<>();
        authorizedScopes1.add("internal_template_mgt_view");
        authorizedScopes1.add("internal_template_mgt_create");
        authorizedScopes1.add("internal_template_mgt_update");
        authorizedScopes1.add("internal_template_mgt_delete");
        orgMgtRestClient.authorizeAPIForB2BApp("Notification Template Management API", "TENANT", authorizedScopes1);
        List<String> authorizedScopes2 = new ArrayList<>();
        authorizedScopes2.add("internal_org_template_mgt_view");
        authorizedScopes2.add("internal_org_template_mgt_create");
        authorizedScopes2.add("internal_org_template_mgt_update");
        authorizedScopes2.add("internal_org_template_mgt_delete");
        orgMgtRestClient.authorizeAPIForB2BApp("Notification Template Management API", "ORGANIZATION",
                authorizedScopes2);
    ...
    @Test(description = "Add an email template in root organization.")
    public void testAddEmailOrgTemplateInRootOrg() throws Exception {
        ...
        Assert.assertNotNull(templateKey, "Failed to add the email template in root organization.");
    }

    @Test(dependsOnMethods = "testAddEmailOrgTemplateInRootOrg",
            description = "Get the email template in first level sub organization.")
    public void testGetEmailOrgTemplateInL1Org() throws Exception {
        ...
        Assert.assertEquals(code, "NTM-65004", "Error code is incorrect.");
    }

    @Test(dependsOnMethods = "testGetEmailOrgTemplateInL1Org",
            description = "Resolve the email template in first level sub organization.")
    ...
    @Test(dependsOnMethods = "testResolveEmailOrgTemplateInL1Org",
            description = "Get the email template in second level sub organization.")
    ...
    @Test(dependsOnMethods = "testGetEmailOrgTemplateInL2Org",
            description = "Resolve the email template in second level sub organization.")
    ...
    @Test(dependsOnMethods = "testResolveEmailOrgTemplateInL2Org",
            description = "Update the email template in root organization.")
    ...
    @Test(dependsOnMethods = "testUpdateEmailOrgTemplateInRootOrg",
            description = "Resolve the updated email template in first level sub organization.")
    ...
    @Test(dependsOnMethods = "testResolveUpdatedRootEmailOrgTemplateInL1Org",
            description = "Resolve the updated email template in second level sub organization.")
    ...
    @Test(dependsOnMethods = "testResolveUpdatedRootEmailOrgTemplateInL2Org",
            description = "Add the email template in first level sub organization.")
    public void testAddEmailOrgTemplateInL1Org() throws Exception {
        ...
        Assert.assertNotNull(templateKey, "Failed to add the email template in first level sub organization.");
    }

    @Test(dependsOnMethods = "testAddEmailOrgTemplateInL1Org",
            description = "Get the added email template in first level sub organization.")
    ...
    @Test(dependsOnMethods = "testResolveAddedL1OrgEmailOrgTemplateInL1Org",
            description = "Resolve the updated email template in second level sub organization.")
    public void testResolveAddedL1OrgEmailOrgTemplateIn21Org() throws Exception {
    ...
    @Test(dependsOnMethods = "testResolveAddedL1OrgEmailOrgTemplateIn21Org",
            description = "Update the email template in first level sub organization.")
    ...
    @Test(dependsOnMethods = "testResolveUpdatedL1OrgEmailOrgTemplateInL2Org",
            description = "Delete the email template in first level sub organization.")
    ...
    @Test(dependsOnMethods = "testDeleteEmailOrgTemplateInL1Org",
            description = "Get the deleted email template in first level sub organization.")
    ...
    @Test(dependsOnMethods = "testGetDeletedL1OrgEmailOrgTemplateInL1Org",
            description = "Resolve the deleted email template in first level sub organization.")
    ...
    @Test(dependsOnMethods = "testResolveDeletedL1OrgEmailOrgTemplateInL1Org",
            description = "Resolve the deleted email template in second level sub organization.")
    ...
    @Test(dependsOnMethods = "testResolveDeletedL1OrgEmailOrgTemplateInL2Org",
            description = "Add the email template in second level sub organization.")
    public void testAddEmailOrgTemplateInL2Org() throws Exception {
        ...
        Assert.assertNotNull(templateKey, "Failed to add the email template in second level sub organization.");
    }

    @Test(dependsOnMethods = "testAddEmailOrgTemplateInL2Org",
            description = "Get the added email template in second level sub organization.")
    ...
    @Test(dependsOnMethods = "testGetAddedL2OrgEmailOrgTemplateInL2Org",
            description = "Resolve the added email template in second level sub organization.")
    ...
    @Test(dependsOnMethods = "testResolveAddedL2OrgEmailOrgTemplateInL2Org",
            description = "Update the email template in second level sub organization.")
    ...
    @Test(dependsOnMethods = "testResolveUpdatedL2OrgEmailOrgTemplateInL2Org",
            description = "Delete the email template in second level sub organization.")
    ...
    @Test(dependsOnMethods = "testDeleteEmailOrgTemplateInL2Org",
            description = "Get the deleted email template in second level sub organization.")
